...
- **C1 validation:** 116 deterministic/invariant/adversarial tests passing; permanent CI covers Python 3.11, 3.12, and 3.13
...
- an independent invariant oracle including Phase-dependency temporal-order validation;
