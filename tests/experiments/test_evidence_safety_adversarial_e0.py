...
def test_contradictory_valid_exact_same_scope_exposes_common_c1_reconciliation_and_commit_defect(
    evaluation,
):
    ...
    for policy_id in PolicyID:
        ...
        assert trial.reconciliation_diverged_from_oracle is True
...
def test_pre_repair_adversarial_summary_exposes_one_real_acr_o4_per_policy(
    evaluation,
):
    for policy_id in PolicyID:
        ...
        assert (acr.numerator, acr.denominator) == (1, 6)
        assert (sser.numerator, sser.denominator) == (1, 6)
